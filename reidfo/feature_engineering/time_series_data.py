...
class TimeSeriesData:
    def __init__(self, series: pd.Series, feature_matrix: pd.DataFrame):
        """
        :param series: Time series indexed by date.
        :param feature_matrix: Feature matrix indexed by date with one column per feature.
        """
        self.series = series
    ...
    def trim(self, start: dt.date | int, end: dt.date | int):
        """
        Trim the stored series and feature matrix to the requested range.

        :param start: Start date or positional index.
        :param end: End date or positional index.
    ...
    def __add__(self, other: "TimeSeriesData") -> "TimeSeriesData":
        """
        :param other: TimeSeriesData object to append after this one.
        :return: New object containing both consecutive time blocks.
        """
    ...
    def __iadd__(self, other: "TimeSeriesData") -> "TimeSeriesData":
        """
        :param other: TimeSeriesData object to append after this one.
        :return: This object extended with the new time block.
        """
        self._check_compatibility(other)
